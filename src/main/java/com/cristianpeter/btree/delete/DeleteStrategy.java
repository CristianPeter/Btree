...
public abstract class DeleteStrategy {
    ...
    public boolean balanceTree(BTreeNode node, int key) throws KeyNotFoundException {
        List<ExceptionalBiPredicate<BTreeNode, Integer>> methods = List.of(
                this::borrowSiblingImpl,
                this::mergeSiblingsImpl
        );
    ...
    private boolean executeInOrder(List<ExceptionalBiPredicate<BTreeNode, Integer>> methods, BTreeNode node, int key) throws KeyNotFoundException {
